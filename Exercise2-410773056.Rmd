...
str_split_fixed(iPeenData$均消,c(" "),n=3) -> temp #(x,找出objects在x的位置,以object為中心做分隔)
temp[,2] -> cost
str_replace_all(cost,",","") -> cost
...
```{r ans21}
#head(filmVotingData$Timestamp,n=156) -> a
#as.factor(a) -> a
...
```{r ans22}
lubridate::with_tz(a,tz = "Asia/Taipei") -> a
a
```
